...
/* 公共样式 */
/*reset*/
html{-webkit-text-size-adjust:100%;height:100%;background-color: #69696B;}
/*reset*/
...
body{font:14px/1.4 "Microsoft Yahei",Arial,Helvetica,sans-serif;background-color: #fff;color:#333;max-width: 640px;margin: 0 auto;height: 100%;}
